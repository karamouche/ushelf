...
- `USHELF_ROOT` selects the directory containing `library/`, `recipes/`, `state/`, and `secrets/`; it defaults to the current working directory. State and secrets follow the root unless their dedicated override variables are set.
