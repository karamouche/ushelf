...
- Tools cover URL and attached-PDF ingestion, X-thread source fallback, enrichment, listing/search, reading state, source refresh, re-enrichment, and confirmation-gated deletion. Images in captured and agent-supplied Markdown are localized by Core before the item is saved.
