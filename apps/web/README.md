...
- When `USHELF_WEB_PASSWORD` is set, the server gates the reader and API behind a password form. The browser uses a server-side session and offers Sign out; expired sessions return to the sign-in page.
